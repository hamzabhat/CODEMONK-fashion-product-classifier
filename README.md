...
```
This will save:
- Model weights to: `backend/models/checkpoints/model_efficientnet.pth`
- Label encoders to: `backend/models/encodings/label_encoders.json`


***Option 2*** — Download pretrained:

👉 [Download pretrained model (.pth) + label encoders](https://drive.google.com/drive/folders/1xQVRHiBioyCYDghrJk-5HKf7c6vZt_Z9?usp=sharing)
